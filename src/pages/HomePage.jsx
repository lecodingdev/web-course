    ...
    <div className="homepage">
          ...
          <Row className="header-box d-flex align-items-center pt-lg-5">
            <Col lg="6">
              <h1 className="mb-4 animate__animated animate__fadeInUp animate__delay-1s">
                Discover <br /> <span>Your Creative Talent</span> <br />
                With Us!
              </h1>
              <p className="mb-4 animate__animated animate__fadeInUp animate__delay-1s">
                Lorem ipsum dolor, sit amet consectetur adipisicing elit.
                Eveniet distinctio dolor provident unde facilis omnis.
              </p>
              <button onClick={() => navigate("/class")} className="btn btn-danger btn-lg rounded-1 me-2 mb-xs-0 mb-2 animate__animated animate__fadeInUp animate__delay-1s">
                Check Class
              </button>
      ...
      <div className="class w-100 min-vh-100">
        <Container>
          <Row>
            <Col>
              <h1 className="text-center fw-bold">Newest Class</h1>
